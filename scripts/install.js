 ...
 *   1. Copies plugin/ to ~/.claude/plugins/cache/mannyyang/claude-pg-mem/<version>/
...
function install() {
  ...
  // 1. Verify plugin/scripts/ has the bundled .cjs files
  const workerCjs = join(PLUGIN_SOURCE, 'scripts', 'worker-service.cjs');
