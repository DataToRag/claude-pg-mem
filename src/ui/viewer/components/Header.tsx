    ...
    <div className="header">
      <h1>
        <div style={{ position: 'relative', display: 'inline-block' }}>
          <img src="claude-pg-mem-logomark.webp" alt="" className={`logomark ${isProcessing ? 'spinning' : ''}`} />
          {queueDepth > 0 && (
        ...
        <span className="logo-text">claude-pg-mem</span>
      </h1>
      <div className="status">
        <a
          href="https://docs.claude-pg-mem.ai"
          target="_blank"
        ...
        <GitHubStarsButton username="thedotmack" repo="claude-pg-mem" />
        <select
          value={currentFilter}
