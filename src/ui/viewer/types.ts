...
export interface Settings {
  ...
  CLAUDE_PG_MEM_GEMINI_MODEL?: string;  // 'gemini-2.5-flash-lite' | 'gemini-2.5-flash' | 'gemini-3-flash-preview'
  CLAUDE_PG_MEM_GEMINI_RATE_LIMITING_ENABLED?: string;  // 'true' | 'false'
