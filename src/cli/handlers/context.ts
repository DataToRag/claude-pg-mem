 ...
 *
 * Calls worker to generate context and returns it as additionalContext
 * for Claude Code to inject into the system prompt.
 */
...
export const contextHandler: EventHandler = {
  async execute(input: NormalizedHookInput): Promise<HookResult> {
    ...
    const showTerminalOutput = settings.CLAUDE_PG_MEMORY_CONTEXT_SHOW_TERMINAL_OUTPUT === 'true';
