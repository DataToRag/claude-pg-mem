...
export function renderSummaryFields(
  ...
  if (useColors) {
    output.push(
      ...Color.renderColorSummaryField('Investigated', summary.investigated, colors.blue),
    );
    output.push(
      ...Color.renderColorSummaryField('Learned', summary.learned, colors.yellow),
    );
    output.push(
      ...Color.renderColorSummaryField('Completed', summary.completed, colors.green),
    );
    output.push(
      ...Color.renderColorSummaryField('Next Steps', summary.next_steps, colors.magenta),
    );
  } else {
    output.push(
      ...Markdown.renderMarkdownSummaryField('Investigated', summary.investigated),
    );
