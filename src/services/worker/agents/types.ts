/**
 * Shared agent types for SDK and other agent implementations
 *
 * Defines common interfaces used across all agent implementations.
 *
...
/**
 * Interface for fallback agent (used by alternative providers to fall back to Claude)
 */
...
export interface BaseAgentConfig {
  dbManager: any; // DatabaseManager - avoid circular import
  sessionManager: any; // SessionManager - avoid circular import
}
