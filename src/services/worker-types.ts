...
export interface ActiveSession {
  ...
  idleTimedOut?: boolean; // Set when session exits due to idle timeout
  lastGeneratorActivity: number; // Timestamp of last generator progress (for stale detection)
  // CLAIM-CONFIRM: Track IDs of messages currently being processed
